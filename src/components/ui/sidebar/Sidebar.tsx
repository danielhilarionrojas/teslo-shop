...
export const Sidebar = () => {
  ...
  return (
    <div>
      ...
      {isSideMenuOpen && (
        <div role="none" onClick={closeMenu} className="fade-id fixed top-0 left-0 w-screen h-screen z-10 backdrop-filter backdrop-blur-sm" />
      )}
      ...
      <nav className={
        ...
        >
          ...
          <span className="ml-3 text-xl">Produts</span>
        </Link>
